...
import gestor_facil from '../../assets/Gesto_Facil.png';
    ...
    return (
         <section id="projetos" className={`${styles.projetos_container} Container`}>
            ...
            <div className={styles.projetos_content}>
                ...
                <BoxProjetos img={gestor_facil} icon={<><FaReact/><BiLogoTypescript/><FaNodeJs/><BiLogoMongodb/></>} title={"Gestor Fácil"} description='Site para você organizar seus projetos e suas finanças' link="https://gestorfacil-gamma.vercel.app"/>
           </div>
        </section>
    )
}